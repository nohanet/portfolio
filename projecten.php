        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card bg-success text-white border-0 shadow h-100 text-center">
                <div class="card-body">
                    ...
                    <a href="project1.php">
                        <img src="mole%20wacker.png" class="img-fluid rounded mt-3" alt="Project 1">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card bg-success text-white border-0 shadow h-100 text-center">
                <div class="card-body">
                    ...
                    <a href="project2.php">
                        <img src="eende screen.png" class="img-fluid rounded mt-3" alt="Project 2">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card bg-success text-white border-0 shadow h-100 text-center">
                <div class="card-body">
                    ...
                    <a href="project3.php">
                        <img src="mld screen.png" class="img-fluid rounded mt-3" alt="Project 3">
                    </a>
                </div>
            </div>
        </div>
