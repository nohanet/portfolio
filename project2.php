            ...
            <div class="card bg-success text-white text-center shadow h-100">
                <div class="card-body">
                    ...
                    <a href="projecten.php">
                        <img src="img/eende screen.png" alt="Eenden Game Screenshot" class="img-fluid rounded mt-3">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-8">
            <div class="card bg-light text-dark shadow">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Dit spel is een <strong>prototype</strong> gemaakt in Game Maker waarin ik basisfuncties zoals <em>lopen</em>,
                        <em>springen</em> en <em>multiplayer</em> introduceer om mijn skills als software developer te laten zien.
                    </p>
                </div>
            </div>
        </div>
